...
class NoAccTourism extends StatefulWidget {
  @override
  _NoAccTourismState createState() => _NoAccTourismState();
}

class _NoAccTourismState extends State<NoAccTourism> {
  @override
  void initState() {
    ...
    getAllAcc(accNotifier, authNotifier.user.email, 'not accepted');
  }
