...
class EditNatural extends StatefulWidget {
  final bool isUpdating;
  EditNatural({@required this.isUpdating});

  @override
  _EditNaturalState createState() => _EditNaturalState();
}

class _EditNaturalState extends State<EditNatural> {
